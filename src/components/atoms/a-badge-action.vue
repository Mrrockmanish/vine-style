<template>
  <div class="flex items-center">
    <svg class="flex-shrink-0 mr-2" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="text-grey-800 text-sm xs:text-base font-medium">
      Купили 86 раз за сутки
    </div>
  </div>
</template>
